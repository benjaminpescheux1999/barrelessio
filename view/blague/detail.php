        ...
        ?>
			<div class="selection col-md-4 col-lg-4 col-sm-4 col-xs-12" >
                <article>
                    ...
                    <p class="text-center"><img class="img-fluid" onclick="fonctionpanier('<?= WEBROOT."panier/mettreaupanier/".$ligne->id_blague ?>')" src="<?= IMAGE ?>img/illustration/<?= $ligne->img_illustration?>" alt="<?= $ligne->titre_blague ?>" /></p>
